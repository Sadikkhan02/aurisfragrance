  ...
  const fetchProductData = async () => {
    products.map((item)=>{
      if(item._id === productId){
        ...
        return null; // Exit the map early
      }
    })
  }
    ...
    <div className='border-t-2 border-gray-300 pt-10 transition-opacity ease-in duration-500 opacity-100'>
      ...
      <div className='mt-20'>
        ...
        <div className='flex flex-col gap-4 border border-gray-300 px-6 py-6 text-sm text-gray-500'>
          <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Nulla ullam minus maiores repellat vitae modi laboriosam? Saepe neque optio sapiente officiis cupiditate nemo, aliquid ipsam, atque, consequatur similique possimus iure?</p>
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio doloremque veniam unde, incidunt quisquam autem sunt, aliquam placeat magni quod, vitae voluptatum accusantium voluptate ipsum vero quas id modi recusandae.</p>
        </div>
      </div>
